                       ...
                       <div class="control-group info">
                        ...
                        <div class="control-group info">
                          <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                              <div class="controls">
                                <input class="form-control" name="name" id="name" type="text" placeholder="Banner Name" value="{{ $postData['name'] ?? '' }}" maxlength="50">
                        ...
                        <div class="control-group info">
                          <div class="row align-items-center">
                            <div class="col-md-4">
                              <label class="span2" for="name_french">French Banner Name</label>
                            </div>
                            <div class="col-md-8">
                              <div class="controls">
                                <input class="form-control" name="name_french" id="name_french" type="text" placeholder="Banner Name" value="{{ $postData['name_french'] ?? '' }}" maxlength="50">
                        ...
                        <div class="control-group info">
                          <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                              <div class="controls">
                                <input class="form-control" name="short_description" id="short_description" type="text" placeholder="short description" value="{{ $postData['short_description'] ?? '' }}" maxlength="150">
                                {{ $errors->first('short_description') ? '<label class="mt-2 text-danger">' . $errors->first('short_description') . '</label>' : '' }}
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="control-group info">
                          <div class="row align-items-center">
                            <div class="col-md-4">
                              <label class="span2" for="short_description_french">French Banner Description</label>
                            </div>
                            <div class="col-md-8">
                              <div class="controls">
                                <input class="form-control" name="short_description_french" id="short_description_french" type="text" placeholder="short description" value="{{ $postData['short_description_french'] ?? '' }}" maxlength="150">
                                {{ $errors->first('short_description_french') ? '<label class="mt-2 text-danger">' . $errors->first('short_description_french') . '</label>' : '' }}
                              </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="col-md-8">
                              <div class="controls">
                                <div class="col-xs-3" style="margin-bottom:15px;">
                                  @php $old_image = $postData['banner_image'] ?? ''; @endphp
                                  @if($old_image != '')
                                    <img src="{{ url('uploads/banners/large/' . $old_image) }}" width="300" height="80"
                                         onerror="this.src='{{ url('uploads/banners/' . $old_image) }}';">
                                  @endif
                        ...
                        <div class="control-group info">
                          <div class="controls">
                            <div class="col-xs-3" style="margin-bottom:15px;">
                              @php $old_image_french = $postData['banner_image_french'] ?? ''; @endphp
                              @if($old_image_french != '')
                                <img src="{{ url('uploads/banners/large/' . $old_image_french) }}" width="300" height="80"
                                     onerror="this.src='{{ url('uploads/banners/' . $old_image_french) }}';">
                              @endif
                        ...
                        <div class="text-right">
                          ...
                          <a href="{{ url('admin/Banners') }}" class="btn btn-success">Back</a>
                        </div>
                      </form>
                    </div>
                </div>
