            ...
            <div class="inner-content-area">
              <div class="row justify-content-center">
                <div class="col-md-12">
                  ...
                  <form method="POST" action="{{ route('admin.products.singleAttributes.addEdit', $id ?? 0) }}" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                   ...
                   <div class="form-role-area">
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <input class="form-control" name="name" id="name" type="text" placeholder="Attribute Name" value="{{ old('name', $postData['name'] ?? '') }}" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <input class="form-control" name="name_french" id="name_french" type="text" placeholder="French Attribute Name" value="{{ old('name_french', $postData['name_french'] ?? '') }}" required>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <button class="btn-success btn-add" type="button">
                    ...
                    <div class="text-right">
                      ...
                      <a href="{{ route('admin.products.singleAttributes.index') }}" class="btn btn-success">Back</a>
                    </div>
                  </div>
                  </form>
                 </div>
