                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12 text-right">
                                    <div class="all-vol-btn">
                                        <a href="{{ route('admin.products.sizeOptions.addEdit', ['id' => 0, 'type' => $type]) }}">
                                        ...
                                        @if(count($lists) > 0)
                                            @foreach($lists as $list)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($list['status'] == 1)
                                                            <a href="{{ route('admin.products.sizeOptions.toggleStatus', [$list['id'], 0, $type]) }}">
                                                                <button type="submit" class="custon-active">Active</button>
                                                            </a>
                                                        @else
                                                            <a href="{{ route('admin.products.sizeOptions.toggleStatus', [$list['id'], 1, $type]) }}">
                                                                <button type="submit" class="custon-delete">Inactive</button>
                                                            </a>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('admin.products.sizeOptions.addEdit', [$list['id'], $type]) }}"
                                                            style="color:green;padding: 5px;" title="edit">
                                                            <i class="fa far fa-edit fa-lg"></i>
                                                        </a>

                                                        <a href="{{ route('admin.products.sizeOptions.delete', [$list['id'], $type]) }}"
