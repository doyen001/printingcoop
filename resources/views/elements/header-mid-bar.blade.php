            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-5 col-xl-5">
                    <div class="header-actions">
                        ...
                        {{-- Login/Logout --}}
                        @if(empty($loginId))
                            <a href="{{ url('Logins') }}" class="action-link join-text">
                                <i class="las la-user-circle" style="font-size: 1.6rem;"></i>
                                {{ $language_name == 'french' ? "S'identifier" : 'Login' }}
                            </a>

                            <span class="action-divider"></span>

                            <a href="{{ url('Logins/register') }}" class="action-link join-text">
                                {{-- <i class="las la-user"></i> --}}
                                {{ $language_name == 'french' ? "S'inscrire" : 'SignUp' }}
                            </a>
                        @else
                            <a href="{{ url('MyAccounts') }}" class="action-link join-text">
                                <i class="las la-user-circle" style="font-size: 1.6rem;"></i>
                                {{ $loginName ?? 'User' }}
                            </a>
                        @endif
                        ...
                        <div class="mid-action-single cart-action">
                            <div class="mid-action-single-inner" style="display: flex; align-items: center; cursor: pointer;">
                                <div class="mid-action-icon" style="position: relative;">
                                    <i class="las la-shopping-cart" style="font-size: 2.5rem; color: #f28738;"></i>
